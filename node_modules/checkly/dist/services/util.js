...
async function getCacheHash(lockFile) {
...
async function getPlaywrightVersion(projectDir) {
    try {
        const modulePath = path.join(projectDir, 'node_modules', '@playwright', 'test', 'package.json');
        const packageJson = JSON.parse(await (0, promises_1.readFile)(modulePath, 'utf-8'));
