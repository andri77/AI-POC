...
class NpmDetector extends PackageManagerDetector {
    ...
    async detectLockfile(dir) {
        return await accessR(node_path_1.default.join(dir, 'package-lock.json'));
    }
...
class PNpmDetector extends PackageManagerDetector {
    ...
    async detectLockfile(dir) {
        return await accessR(node_path_1.default.join(dir, 'pnpm-lock.yaml'));
    }
    async detectExecutable(lookup) {
...
class YarnDetector extends PackageManagerDetector {
    ...
    async detectLockfile(dir) {
        return await accessR(node_path_1.default.join(dir, 'yarn.lock'));
    }
    async detectExecutable(lookup) {
...
class DenoDetector extends PackageManagerDetector {
    ...
    async detectLockfile(dir) {
        return await accessR(node_path_1.default.join(dir, 'deno.lock'));
    }
    async detectExecutable(lookup) {
...
class BunDetector extends PackageManagerDetector {
    ...
    async detectLockfile(dir) {
        return await accessR(node_path_1.default.join(dir, 'bun.lockb'));
    }
    async detectExecutable(lookup) {
